...
if ( file_exists( get_template_directory() . '/inc/wp-less/lessc.inc.php' ) ) {
	// load LESS parser
	require_once( get_template_directory() . '/inc/wp-less/lessc.inc.php' );
}
...
if ( ! class_exists( 'wp_less' ) ) {
	...
	class wp_less {
      ...
      if(!$wp_filesystem->put_contents( $css_path, $file_contents ) ) { 
