<div class="wrap about-wrap">
  <h1>Howdy!</h1>
  <div class="about-text">Congratulations! You are using our powerful WordPress theme for Psychologists, built for you by a great team at <a href="https://themebully.com">ThemeBully.com</a></div>

  <div class="osetin-intro-box">
    <h3><span class="dashicons dashicons-editor-help"></span> Questions?</h3>
    <ul>
      <li><a href="http://psych.pinsupreme.com/docs/index.html" target="_blank">Read Documentation</a></li>
      <li><a href="http://psych.pinsupreme.com/docs/index.html#headingFaqs" target="_blank">Read FAQ</a></li>
  ...
  <div class="osetin-intro-box">
    ...
    <a href="http://psych.pinsupreme.com/docs/index.html#headingImportingDemoDataXML" target="_blank">Learn How to Import Demo Data</a>
  </div>
  ...
  <div class="osetin-intro-box osetin-intro-newsletter-box">
    ...
    <div class="mc-field-group">
      <label for="mce-EMAIL">Enter your email address</label><input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Your email address">
    </div>
